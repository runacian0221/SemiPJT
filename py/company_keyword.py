...
class CompanyKeywords:
    ...
    def calculate_tfidf(self):
        ...
        for idx, row in self.grouped_df.iterrows():
            ...
            self.keywords_df = self.keywords_df.append({'company': company, 'keywords': top_5_keywords, '자소서갯수': content_count}, ignore_index=True)
...
if __name__ == "__main__":
    ...
    extractor.run('company_keywords.csv')
